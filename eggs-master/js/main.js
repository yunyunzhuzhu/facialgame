...
function updateData(data) {
    // console.log(data);
    document.getElementById("angry").innerHTML = data[0].value;
    document.getElementById("sad").innerHTML = data[1].value;
    document.getElementById("surprised").innerHTML = data[2].value;
    document.getElementById("happy").innerHTML = data[3].value;
